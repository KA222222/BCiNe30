...
public class BCiNe30App {

    private static final Logger log = LoggerFactory.getLogger(BCiNe30App.class);

    private final Environment env;

    public BCiNe30App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BCiNe30App.class);
